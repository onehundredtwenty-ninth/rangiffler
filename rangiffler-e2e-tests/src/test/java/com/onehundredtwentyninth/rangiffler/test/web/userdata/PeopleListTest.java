...
class PeopleListTest extends BaseWebTest {
  ...
  @DisplayName("[web] Получение всех пользователей по переданному username")
  @ApiLogin
  @CreateUser
  @Test
  ...
  @DisplayName("[web] Получение пользователей при передаче SearchQuery username автора запроса")
  @ApiLogin
  @CreateUser
  @Test
  ...
  @CreateExtrasUsers(@CreateUser)
  @DisplayName("[web] Получение всех пользователей по переданному firstname")
  @ApiLogin
  @CreateUser
  @Test
  ...
  @CreateExtrasUsers(@CreateUser)
  @DisplayName("[web] Получение всех пользователей по переданному lastname")
  @ApiLogin
  @CreateUser
  @Test
