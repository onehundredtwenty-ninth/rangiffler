package com.onehundredtwentyninth.rangiffler.constant;
...
public class Features {
  ...
  public static final String COUNTRY_LIST = "Получение списка стран";
  public static final String COUNTRY = "Получение страны";
